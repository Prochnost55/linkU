  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div id="friend"><h4>Abhishek Singh</h4></div>
        <div id="friend-active"><h4>Pratyush Aswal</h4></div>
        <div id="friend"><h4>Abhishek Singh</h4></div>
        <div id="friend"><h4>Abhishek Singh</h4></div>
      </div>
      <div class="msg-box">
          <div id="sent">hey</div>
          <div id="received"> hello</div>
       </div>    
          <div id="input-box">
          <form action="sent-message.php" method="post">
            <label for="inputName" class="sr-only">Name</label>
            
            <input type="text" class="usermessage" placeholder="Type your message here.">
